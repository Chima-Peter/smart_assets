              ...
              <table className="min-w-full divide-y divide-gray-300">
                <thead className="bg-gray-800">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-bold text-white uppercase">IP Address</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-300">
                  {logs.map((log) => (
                    <tr key={log.id} className="hover:bg-gray-100">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-700">{log.ipAddress || "—"}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
