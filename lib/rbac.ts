...
export const PERMISSIONS = {
  ...
  CREATE_REQUEST: [ROLES.LECTURER, ROLES.FACULTY_ADMIN],
  ...
  INITIATE_TRANSFERS: [ROLES.DEPARTMENTAL_OFFICER, ROLES.FACULTY_ADMIN],
  TRANSFER_OWN_ASSETS: [ROLES.LECTURER, ROLES.DEPARTMENTAL_OFFICER, ROLES.FACULTY_ADMIN], // Lecturers can transfer assets they have
  ...
  REQUEST_CONSUMABLES: [ROLES.LECTURER, ROLES.FACULTY_ADMIN],
